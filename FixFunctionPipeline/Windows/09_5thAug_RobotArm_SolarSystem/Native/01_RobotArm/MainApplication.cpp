...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("RollNo 74 | Sachin Bhadrashette | Matrix Stack Robot Arm "),
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_CHAR:
		...
		case 0x73 : //s key rotate at shoulder
			shoulder = (shoulder + 5) % 360;
			break;

		case 0x53 : //S key rotate at shoulder
			shoulder = (shoulder - 5) % 360;
			break;

		case 0x65 : //e key rotate at elbow
			elbow = (elbow + 5) % 360;
			break;

		case 0x45: //E key rotate at elbow
			elbow = (elbow - 5) % 360;
			break;
		case 0x46:
			if (gbFullScreen == false) {
