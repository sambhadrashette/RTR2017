...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpszCmdLine, int iCmdShow) {
	...
	hwnd = CreateWindowEx(WS_EX_APPWINDOW,
		szClassName,
		TEXT("RollNo 74 | Sachin Bhadrashette | Apple logo "),
...
void drawAppleLogo(){
	...
	//apple left part
	glTranslatef(0.40f, 0.0f, -8.0f);
	glPolygonMode(GL_FRONT, GL_FILL);
	glScalef(1.13f, 1.5f, 1.0f);
	...
	glTranslatef(-0.80f, 0.00f, 0.0f);
	glColor3f(1.0f, 1.0f, 1.0f);
	gluSphere(quadric, 0.75, 100, 100);

	//apple cut part
	glTranslatef(1.38f, 0.2f, 1.0f);
	glScalef(0.20f, 0.3f, 0.0f);
	glColor3f(0.0f, 0.0f, 0.0f);
	gluSphere(quadric, 0.75, 100, 100);

	//apple petiole
	glTranslatef(-4.0f, 2.2f, 0.0f);
	glRotatef(40.0f, 0.0f, 0.0f, 1.0f);
	glScalef(1.50f, 0.4f, 0.0f);
	glColor3f(1.0f, 1.0f, 1.0f);
	gluSphere(quadric, 0.75, 100, 100);
