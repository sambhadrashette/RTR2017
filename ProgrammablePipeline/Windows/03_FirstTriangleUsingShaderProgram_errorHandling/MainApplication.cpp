...
void resize(int width, int height) {
	...
	if (width <= height) {
		gOrthographicProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0*(height / width)), (100 * (height / width)), -100.0f, 100.0f);
	}
	else {
		gOrthographicProjectionMatrix = ortho(-100.0f, 100.0f, (-100.0*(width / height)), (100 * (width / height)), -100.0f, 100.0f);
	}
}
