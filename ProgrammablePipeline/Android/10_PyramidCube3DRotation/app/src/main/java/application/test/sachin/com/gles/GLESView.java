...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    private float gAngle_pyramid = 0.0f;
    ...
    private void initialize(GL10 gl) {
        ...
        ByteBuffer byteColorBuffer = ByteBuffer.allocateDirect(pyramidColors.length * 4);
        ...
        ByteBuffer byteColorBufferCube = ByteBuffer.allocateDirect(cubeColors.length * 4);
        byteColorBufferCube.order(ByteOrder.nativeOrder());

        FloatBuffer colorBufferCube = byteColorBufferCube.asFloatBuffer();
    ...
    private void draw() {
        ...
        Matrix.rotateM(rotationMatrix,0, gAngle_pyramid,0.0f,1.0f,0.0f);
        ...
        Matrix.translateM(modelviewMatrix,0, 1.5f, 0.0f, -5.0f);
        Matrix.rotateM(rotationMatrix, 0, gAngle_cube, 1.0f, 0.0f, 0.0f);
        Matrix.rotateM(rotationMatrix, 0, gAngle_cube, 0.0f, 1.0f, 0.0f);
        Matrix.rotateM(rotationMatrix, 0, gAngle_cube, 0.0f, 0.0f, 1.0f);
